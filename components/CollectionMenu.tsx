...
export function CollectionMenu({
    ...
    return (
        <>
            ...
            {/* Panel del menú */}
            <div
                className={`fixed top-0 right-0 h-full w-full max-w-md bg-white z-[95] shadow-2xl transform transition-transform duration-300 ease-out ${isOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
                {/* Header */}
                <div
