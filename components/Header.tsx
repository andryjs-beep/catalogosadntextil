                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {socialLinks.instagram && (
                            <a
                                ...
                                className="p-2 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 text-white hover:scale-110 transition-transform hidden sm:flex"
                        ...
                        {socialLinks.facebook && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-2 rounded-full bg-blue-600 text-white hover:scale-110 transition-transform hidden sm:flex"
                                aria-label="Facebook"
                            >
                        ...
                        {socialLinks.tiktok && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-2 rounded-full bg-black text-white hover:scale-110 transition-transform hidden sm:flex"
                                aria-label="TikTok"
                            >
